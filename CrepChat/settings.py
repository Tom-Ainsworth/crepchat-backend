...
# Define media storage for images etc
MEDIA_URL = "/media/"

# Define default file storage in cloudinary
...
VERCEL_EXTERNAL_HOSTNAME = os.environ.get("VERCEL_EXTERNAL_HOSTNAME")
